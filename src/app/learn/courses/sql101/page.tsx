...
import { getAllModules } from "@/lib/learn/courses/sql101/index";
...
export default function Sql101Page() {
  ...
  const totalCorrect = Object.entries(progress)
    .filter(([key]) => key.startsWith('sql101/'))
    ...
    return (
      <AuthGuard>
        <main className="min-h-screen bg-[var(--page-bg)] flex items-center justify-center">
          <p className="text-slate-400">This course is only available to admins.</p>
        </main>
      </AuthGuard>
    );
  }
        ...
        <div className="mx-auto w-full max-w-6xl flex flex-col gap-10">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <h1 className="text-3xl font-semibold text-white">SQL 101</h1>
                </div>
              </div>
            </div>
          ...
          <section className="space-y-6">
            ...
            <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
              {modules.map((mod) => {
                const p = progress[`sql101/${mod.slug}`];
